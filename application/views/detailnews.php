...
<div class="container" style="margin-top: 75px; margin-bottom: 40px">
	<div class="row">
		<div class="col-md-8">
			<p>News <span class="glyphicon glyphicon-chevron-right" style="font-size: 12px"></span> <a href="#">Tag</a> <span class="glyphicon glyphicon-chevron-right" style="font-size: 12px"></span> <a href="#"><?php echo $news['judul_news'];?></a></p>
			<br>
